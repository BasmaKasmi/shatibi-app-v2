...
interface CdsConfirmationProps {
  onConfirm: () => void;
  onCancel: () => void;
}

const CdsConfirmation = ({ onConfirm, onCancel }: CdsConfirmationProps) => {
  return (
    <div className="relative p-2 grid justify-items-center">
      ...
      <h3 className="text-center text-lg font-semibold text-black my-4">
        Confirmez-vous l&apos;envoi du cahier de séance ?
      </h3>
...
export default CdsConfirmation;
