...
import StudentGroupStats from "@/components/StudentGroupStats";
...
export const StudentModalContentWrapper = ({
  ...
  const [modalToDisplay, setModalToDisplay] = useState<
    "StudentGroupStats" | "StudentDates" | "ConfirmAp" | "CorresConfirm"
  >("StudentGroupStats");
  ...
  const handleClickCancelStudentDates = () => {
    setModalToDisplay("StudentGroupStats");
  };
  ...
  return (
    <>
      {modalToDisplay === "StudentGroupStats" && (
        <StudentGroupStats
